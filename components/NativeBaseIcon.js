...
import { Icon, Text, Input, Label, View, TextArea, Box } from "native-base";
import { G, Path } from "react-native-svg";
const NativeBaseIcon = () => {
  return (
    // <Col style={{ backgroundColor: "#ADD9EF" }}>
    <View>
      <Text>First Name</Text>
      <Input width={400}></Input>
      <Text>Last Name</Text>
      <Input></Input>
      <Text>Description</Text>
      <TextArea h={20} placeholder="Text Area Placeholder" w="100%" maxW="400" />
